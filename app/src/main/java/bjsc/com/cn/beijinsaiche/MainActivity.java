package bjsc.com.cn.beijinsaiche;
...
import bjsc.com.cn.beijinsaiche.adapter.MainAdapter;
import bjsc.com.cn.beijinsaiche.fragment.HomePageFragment;
import bjsc.com.cn.beijinsaiche.fragment.KaijiangFragment;
import bjsc.com.cn.beijinsaiche.fragment.ZoushiFragment;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener, ViewPager.OnPageChangeListener {
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem(R.drawable.ic_home_black_24dp, "首页").setActiveColorResource(R.color.white))
                .addItem(new BottomNavigationItem(R.drawable.ic_local_atm_black_24dp, "最新开奖").setActiveColorResource(R.color.white))
                .addItem(new BottomNavigationItem(R.drawable.ic_timeline_black_24dp, "最新势图").setActiveColorResource(R.color.white).setBadgeItem(badgeItem))
